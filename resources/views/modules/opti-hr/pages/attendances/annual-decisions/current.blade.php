...
@section('admin-content')
    ...
    <div class="modal fade" id="addDecisionModal" tabindex="-1" aria-labelledby="addDecisionModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="decisionForm" action="{{ route('decisions.save', $decision->id ?? null) }}" method="POST"
                    ...
                    success: function(response) {
                        if (response.ok) {
                            ...
                            Swal.fire({
                                ...
                                // Redirect to the decisions list
                                window.location.href = "{{ route('decisions.index') }}";
                            });
                        } else {
                            $('#confirmDeleteModal').modal('hide');
