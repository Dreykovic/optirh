...
@section('admin-content')
            ...
            <div
                ...
                <div class="col-auto d-flex w-sm-100">
                    <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal"
                        data-bs-target="#addAccount"><i class="icofont-plus-circle me-2 fs-6"></i>Nouveau compte</button>
                </div>
            </div>
        </div>
    </div> <!-- Row end  -->
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center p-5">
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#addAccount"
    ...
    @include('pages.admin.account.create')
@endsection
@push('plugins-js')
