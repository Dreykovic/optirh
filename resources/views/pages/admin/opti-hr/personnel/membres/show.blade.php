...
@section('admin-content')
    ...
    @include('pages.admin.opti-hr.personnel.membres.edits.edit-pers-info')
    @include('pages.admin.opti-hr.personnel.membres.edits.edit-pers-identity')
    @include('pages.admin.opti-hr.personnel.membres.edits.edit-bank-info')
@endsection
@push('plugins-js')
@endpush
@push('js')
