                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-fill ms-4 text-truncate">
                                            @if ($department->director)
                                                <span class="fw-bold ms-1">{{ $department->director->first_name }}
                                                    {{ $department->director->last_name }}</span>
                                            @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            <button onclick="loadJobEmployees({{ $job->id }})" type="button"
                                                class="btn btn-outline-secondary" data-bs-toggle="modal"
                                                data-bs-target="#job_employees" data-bs-job-id='{{ $job->id }}'><i
