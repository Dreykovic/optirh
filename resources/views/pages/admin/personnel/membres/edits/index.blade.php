...
<form id="modelAddForm" class='col-xl-10 col-lg-10 col-sm-12 row bg-light' data-model-add-url="{{ route('membres.data.update',$employee->id) }}">
    @csrf
    ...
    <legende class="w-auto px-2 fs-6 shadow-4 text-muted fw-bold shadow"><span class='mb-4'>Identité</span></legende>
        <div class="row g-3 mb-3 mt-2">
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="last_name" value='{{$employee->last_name}}' name='last_name' placeholder="">
            </div>
            <div class="col-sm-6">
        ...
        <div class="row g-3 mb-3">
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" value='{{$employee->nationality}}' id="nationality" name='nationality' placeholder="">
            </div>
            <div class="col-sm-6">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-sm-6">
                ...
                <select class="form-select" aria-label="Default select Project Category" id="gender" name='gender'>
                    <option selected value='{{$employee->gender}}'>{{$employee->gender == 'MALE' ? 'Homme':'Femme'}}</option>
        ...
        <div class="col-sm-6">
            ...
            <input type="date" value='{{$employee->birth_day}}' class="form-control" id="birth_date" name='birth_date'>
        </div>
    </fieldset>
    ...
    <div class="row g-3 mb-3 mt-2">
            <div class="col-sm-6">
                ...
                <input type="email" value='{{$employee->email}}' class="form-control" id="email" name='email' placeholder="">
            </div>
            <div class="col-sm-6">
                <label for="phone_number" class="form-label">Contact</label>
                <input type="text" value='{{$employee->phone_number}}' class="form-control" id="phone_number" name='phone_number'>
            </div>
        </div>
        <!--  -->
        <div class="row g-3 mb-3">
            <div class="col-sm-6">
                ...
                <input type="text" value='{{$employee->emergency_contact}}' class="form-control" id="emergency_contact" name='emergency_contact'>
            </div>
            <div class="col-sm-6">
                <label for="address1" class="form-label">Adresse</label>
                <input type="text" value='{{$employee->address1}}' class="form-control" id="address1" name='address1'>
            </div>
        </div>
        <!--  -->
        <div class="row g-3 mb-3">
            <div class="col-sm-6">
                ...
                <input type="city" value='{{$employee->city}}' class="form-control" id="city" name='city' placeholder="">
            </div>
            <div class="col-sm-6">
                <label for="state" class="form-label">Quartier</label>
                <input type="state" value='{{$employee->state}}' class="form-control" id="state" name='state' placeholder="">
            </div>
    ...
    <legende class="w-auto px-2 fs-6 shadow-4 text-muted fw-bold shadow"><span class='mb-4'>Compte Banque</span></legende>
        <div class="row g-3 mb-3 mt-2">
            <div class="col-sm-6">
                ...
                <input type="text" value='{{$employee->bank_name}}' class="form-control" id="bank_name" name='bank_name' placeholder="">
            </div>
            <div class="col-sm-6">
                <label for="rib" class="form-label">No. Compte</label>
                <input type="text" value='{{$employee->rib}}' class="form-control" id="rib" name='rib'>
            </div>
        </div>
        <!--  -->
        <div class="row g-3 mb-3">
            <div class="col-sm-6">
                ...
                <input type="text" value='{{$employee->iban}}' class="form-control" id="iban" name='iban' placeholder="">
            </div>
            <div class="col-sm-6">
                <label for="swift" class="form-label">Swift</label>
                <input type="text" value='{{$employee->swift}}' class="form-control" id="swift" name='swift'>
            </div>
        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-sm-6">
                ...
                <input type="cle_rib" value='{{$employee->cle_rib}}' class="form-control" id="cle_rib" name='cle_rib' placeholder="">
            </div>
            <div class="col-sm-6">
                <label for="code_bank" class="form-label">Code Banque</label>
                <input type="code_bank" value='{{$employee->code_bank}}' class="form-control" id="code_bank" name='code_bank' placeholder="">
            </div>
        </div>
        <!--  -->
        <div class="col-sm-6">
            <label for="code_guichet" class="form-label">Code Guichet</label>
            <input type="text" value='{{$employee->code_guichet}}' class="form-control" id="code_guichet" name='code_guichet'>
        </div>
    </fieldset>
