            ...
            <div class="card-body">
                <div class='d-flex justify-content-between mb-3'>
                    ...
                    <form action="/files/upload" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary mt-3">Envoyer les documents</button>
                    </form>
...
<script>
    ...
    row.innerHTML = `
        ...
        <td>
            <input type="file" class="form-control" name="files[${employee.id}]" placeholder="Sélectionner un fichier">
        </td>
        <td>
            <div class="btn-group">
