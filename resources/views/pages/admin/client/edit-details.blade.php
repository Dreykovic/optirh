<div class="modal fade" id="editClientDetails" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title  fw-bold" id="editClientDetailsLabel"> Informations personnelles</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="deadline-form">
                    <form class="modelUpdateForm" data-model-update-url="{{ route('clients.update', $client) }}">
                        <div class="modal-body">

                            <div class="mb-3">
                                <label for="nomClient" class="form-label required">Nom</label>
                                <input type="text" class="form-control" id="nomClient"
                                    placeholder="Nom complet du client" name="nom_client" value="{{ $client->name }}">
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="ville"
                                        placeholder="Ville Du client" name="ville" required
                                        value="{{ $client->city }}">
                                </div>
                                <div class="col">
                                    <label for="quartier" class="form-label">QUartier</label>
                                    <input type="text" class="form-control" id="quartier"
                                        placeholder="Quartier Du Client" name="quartier" required
                            ...
                            <div class="row form-group mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="job"
                                        placeholder="Profession du client" name="profession"
                                        value="{{ $client->job }}">
                                </div>
                            </div>
                            ...
                            <div class="row form-group mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" id="email"
                                        placeholder="Email Du Client" name="email" value="{{ $client->email }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <label>
                                        <input type="radio" name="sexe" value="Féminin"
                                            {{ $client->gender === 'Feminin' ? 'checked' : '' }}> Féminin
                                    </label>

                                    <label>
                                        <input type="radio" name="sexe" value="Masculin"
                                            {{ $client->gender === 'Masculin' ? 'checked' : '' }}>Masculin
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary modelUpdateBtn" atl="update client"
